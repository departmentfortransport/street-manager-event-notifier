...
describe('ActivityDataMapper', () => {
  ...
  describe('mapActivityDataToEventNotifierActivityData', () => {
    it('should map the activity data to event notifier activity data', () => {
      ...
      assert.equal(eventNotifierActivityData.activity_type_details, activityData.activity_type_details)
      ...
      assert.equal(eventNotifierActivityData.activity_location_description, activityData.activity_location_description)
